          ...
          <div className="controls  align-items-center position-sticky top-0">
            <div className="d-flex align-items-start gap-2 border-bottom mb-3">
              <Select
                options={options}
                isMulti={true}
                placeholder={"Choose group or class"}
                className="mb-3 select w-100"
              />
...
const options = [
  { value: "Thesis Writing 1", label: "THS1" },
  { value: "Thesis Writing 2", label: "THS2" },
  { value: "CS Practicum", label: "CSPRAC" },
];
